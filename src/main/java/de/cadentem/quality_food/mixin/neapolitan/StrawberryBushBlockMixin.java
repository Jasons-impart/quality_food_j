...
/** Provide harvest context (player + farmland) when strawberries are picked by hand */
@Mixin(StrawberryBushBlock.class)
public abstract class StrawberryBushBlockMixin {
    @WrapOperation(method = "useWithoutItem", at = @At(value = "INVOKE", target = "Lcom/teamabnormals/neapolitan/common/block/StrawberryBushBlock;popResource(Lnet/minecraft/world/level/Level;Lnet/minecraft/core/BlockPos;Lnet/minecraft/world/item/ItemStack;)V"))
